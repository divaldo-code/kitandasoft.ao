...
import { ArrowLeft, FileText, Scale, AlertTriangle, CreditCard, Headphones, Globe } from "lucide-react";
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 space-y-8">
          ...
          <section>
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
              Estes Termos de Serviço regem o uso do software KitandaSoft, desenvolvido e comercializado pela 
              GC LUCAN. Ao utilizar o nosso software, concorda com estes termos na sua totalidade.
            </p>
            <div className="bg-yellow-50 dark:bg-yellow-900/30 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4">
              <div className="flex items-start space-x-2">
                <AlertTriangle className="h-5 w-5 text-yellow-600 dark:text-yellow-400 mt-0.5" />
                <p className="text-sm text-yellow-800 dark:text-yellow-200">
                  <strong>Importante:</strong> Estes termos aplicam-se às duas modalidades do KitandaSoft: 
                  Online (SaaS) e Local (Instalação própria).
                </p>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4">
              <p className="text-gray-700 dark:text-gray-300">
                O software KitandaSoft, incluindo código-fonte, design, documentação e materiais relacionados, 
                são propriedade exclusiva da GC LUCAN e estão protegidos por leis de direitos autorais.
              </p>
              <ul className="text-gray-700 dark:text-gray-300 space-y-2 ml-4">
                <li>• <strong>Proibida</strong> a cópia, distribuição ou modificação não autorizada</li>
                <li>• <strong>Proibida</strong> a engenharia reversa do software</li>
                <li>• <strong>Permitido</strong> o uso conforme licença adquirida</li>
                <li>• <strong>Permitida</strong> a personalização de relatórios e documentos</li>
              </ul>
            </div>
          </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <ul className="text-gray-700 dark:text-gray-300 space-y-2 text-sm">
                  ...
                  <li>• Usar o software conforme a lei</li>
          ...
          <section>
            ...
            <div className="space-y-4">
              <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Versão Online:</h3>
              ...
              <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Versão Local:</h3>
                <ul className="text-gray-700 dark:text-gray-300 space-y-1 text-sm">
          ...
          <section>
            ...
            <div className="space-y-4">
              <div className="bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-800 rounded-lg p-4">
                <h3 className="font-semibold text-green-800 dark:text-green-200 mb-2">Horário de Suporte:</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <h4 className="font-medium text-gray-900 dark:text-white mb-2">Canais de Suporte:</h4>
                  <ul className="text-gray-700 dark:text-gray-300 space-y-1 text-sm">
                ...
                <div>
                  <h4 className="font-medium text-gray-900 dark:text-white mb-2">Tipos de Suporte:</h4>
                  <ul className="text-gray-700 dark:text-gray-300 space-y-1 text-sm">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-800 rounded-lg p-4 mt-4">
                <p className="text-red-800 dark:text-red-200 text-sm">
                  <strong>Importante:</strong> Recomendamos vivamente a realização de backups regulares 
                  dos seus dados, independentemente da versão utilizada.
                </p>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Pelo Cliente:</h3>
              <ul className="text-gray-700 dark:text-gray-300 space-y-2 ml-4">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Pela GC LUCAN:</h3>
              <ul className="text-gray-700 dark:text-gray-300 space-y-2 ml-4">
          ...
          <section>
            ...
            <div className="bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-800 rounded-lg p-6">
              <p className="text-blue-800 dark:text-blue-200 mb-4">
                O KitandaSoft é um software certificado pela Administração Geral Tributária (AGT) de Angola 
                sob o número <strong>505/AGT/2025</strong>.
              </p>
            ...
            <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  ...
                  <p><strong>WhatsApp:</strong> +244 944 178 180</p>
          ...
          <section>
            ...
            <p className="text-gray-700 dark:text-gray-300">
              A GC LUCAN reserva-se o direito de alterar estes termos a qualquer momento. As alterações 
              entrarão em vigor 30 dias após a notificação aos utilizadores. O uso continuado do software 
