    ...
    <section className="bg-white py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative">
          ...
          <button
            onClick={prevSlide}
            className="absolute left-0 top-1/2 -translate-y-1/2 z-10 p-3 rounded-full border border-gray-300 bg-white hover:bg-gray-50 transition-colors"
          >
          ...
          <button
            onClick={nextSlide}
            className="absolute right-0 top-1/2 -translate-y-1/2 z-10 p-3 rounded-full border border-gray-300 bg-white hover:bg-gray-50 transition-colors"
          >
              ...
              {testimonials.map((testimonial) => (
                <div key={testimonial.id} className="w-1/3 flex-shrink-0 px-4">
                  <div className="bg-white border border-gray-200 rounded-lg p-8 h-full">
                    ...
                    {/* Quote */}
                    <blockquote className="text-gray-900 text-lg leading-relaxed mb-8">
                      "{testimonial.quote}"
                    </blockquote>
